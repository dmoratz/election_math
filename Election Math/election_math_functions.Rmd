...
rcv_pew_data_2020 <- rcv_analysis(pew_margin_2016, pew_margin_2020)

# Apply to 2024 vs 2020 Pew Data
rcv_pew_data_2024 <- rcv_analysis(pew_margin_2020, pew_margin_2024)
```
...
data_to_write <- list(derivative_grimmer_data = derivative_grimmer_data, 
                      ...
                      rcv_pew_data_2020 = rcv_pew_data_2020,
                      rcv_pew_data_2024 = rcv_pew_data_2024)
