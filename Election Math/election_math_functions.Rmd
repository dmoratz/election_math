...
rm(list = ls())
library(pacman)
p_load(MCMCpack, foreign, haven, ggplot2, broom, DataCombine, plm, estimatr, gsynth, reshape2, zoo, stargazer, did, here, etwfe, modelsummary, interflex, sandwich, multcomp, lmtest, kableExtra, texreg, fastDummies, ggdag, AER, MatchIt, cobalt, coda,stats, tidyr, cowplot, blocs, dplyr)
